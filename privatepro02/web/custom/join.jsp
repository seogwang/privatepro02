        ...
        <form name="frm1" id="frm1" action="${path }/JoinPro.do" method="post" onsubmit="return joinCheck(this)">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-row">
                            <input type="text" name="id" id="id" placeholder="영문소문자 및 숫자를 혼용하여 아이디 입력" class="form-control"
                                   pattern="^[a-z0-9]{8,16}" maxlength="16" autofocus required />
            ...
            <div class="btn-group">
                <input type="submit" name="submit-btn" class="btn btn-outline-primary" value="회원가입">
                <input type="reset" name="reset-btn" class="btn btn-outline-primary" value="취소">
                <a href="${path }/Login.do" class="btn btn-outline-primary">로그인</a>
            </div>
        </form>
        <script>
